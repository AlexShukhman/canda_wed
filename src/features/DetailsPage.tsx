...
export function DetailsPage () {
  ...
  return (
    <div className='detailsPage'>
      <div className="faq">
        <h1>FAQ</h1>
        <p><i>You've got questions, we've got answers.</i></p>
        <hr/>
        ...
        <p>We tried really, really hard to keep things small (under 60 people). If you go to the RSVP tab and type in your name, it will specify if you get a plus-one. Let us know if you have any questions or concerns.</p>
        ...
        <p>Because we have plenty of stuff, we ask that in lieu of gifts, you give whatever you can to one (or more!) of a list of organizations that we care a lot about. See Registry page for details, links, and cat pictures.</p>
